...
# --- STATE TANIMI ---
for key in ['genre_recommendations', 'search_recommendations', 'random_recommendations', 'genre_selected', 'user_input']:
...
user_input = st.text_input("İçerik başlığını girin (örneğin: Narcos):", value=st.session_state.get("user_input", ""))
